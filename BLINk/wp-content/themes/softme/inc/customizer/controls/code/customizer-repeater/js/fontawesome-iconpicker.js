(function ($) {
    ...
    wp.softmecustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                softme_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.softmecustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.softmecustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.softmecustomizerRepeater.iconPickerToggle($(this));
        });
