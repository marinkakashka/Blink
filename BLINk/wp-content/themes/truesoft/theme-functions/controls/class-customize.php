 ...
 */
final class TrueSoft_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Softme_Customize_Section_Pro(
				...
				'softme',
				array(
                    'pro_text' => esc_html__( 'Upgrade to TrueSoft Pro','truesoft' ),
                    'pro_url'  => 'https://desertthemes.com/themes/truesoft-pro/',
                    'priority' => 0
                )
			)
		);
...
TrueSoft_Customize::get_instance();