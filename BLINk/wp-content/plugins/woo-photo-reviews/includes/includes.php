...
define( 'WOO_PHOTO_REVIEWS_PLUGINS', WOO_PHOTO_REVIEWS_DIR . "plugins" . DIRECTORY_SEPARATOR );
...
vi_include_folder( WOO_PHOTO_REVIEWS_PLUGINS, 'VI_WOO_PHOTO_REVIEWS_Plugins_' );
